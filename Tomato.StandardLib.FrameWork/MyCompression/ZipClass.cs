...
namespace Tomato.StandardLib.MyCompression
{
    /// <summary>
    /// 压缩和解压文件
    /// </summary>
    public class ZipClass
    {
        ...
        /// <param name="zipfilepath">待解压缩的文件路径</param>
        /// <param name="unzippath">解压缩到指定目录</param>
        public void FastUnZip(string zipfilepath, string unzippath)
        {
            FastZip fastZip = new FastZip();
            fastZip.ExtractZip(zipfilepath, unzippath, string.Empty);
        }
    }
}